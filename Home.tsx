...
const HomeScreen = ({navigation}) => {
  ...
  <View style={styles.bannerContainer}>
      ...
      <View style={styles.banner}>
        <View style={styles.textContainer}>
          ...
          <TouchableOpacity style={styles.button}>
            <Text style={styles.buttonText}>Get Your Course below</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.courseOfTheWeek}>
        <Image source={require('../assets/Logoimg.jpg')} style={styles.courseWeekImage} />
      ...
      <View style={styles.courseOfTheWeek}>
        <Image source={require('../assets/homesscren.jpg')} style={styles.courseWeekImage} />
        <View style={styles.courseDetails}>
