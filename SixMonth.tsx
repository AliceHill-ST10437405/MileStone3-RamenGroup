...
export default function SixMonthScreen({ navigation }) {
  ...
  const [courses, setCourses] = useState([
    ...
    { title: 'Landscapping', description: 'Learn landscaping services for new and established gardens.', screen: 'Landscapping' },
  ...
  return (
    <ImageBackground
      source={require('../assets/sixmonthh.jpg')} // Replace with the correct image path
